...
class FanProfile(db.Model):
    ...
    uploaded_doc_filename = db.Column(db.String(255), nullable=True)
    doc_ocr_result = db.Column(db.Text, nullable=True)
    ...
    # <<< NOVAS COLUNAS ADICIONADAS (Facebook, Instagram, TikTok) >>>
